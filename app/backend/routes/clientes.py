...
INVALID_EMAIL_MESSAGE = "El email debe tener el formato usuario@dominio"
INVALID_PHONE_MESSAGE = "El teléfono debe contener solo números y guiones"
INVALID_DNI_MESSAGE = "El DNI debe contener solo números (7 u 8 dígitos)"
